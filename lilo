  ...
  if [[ $OPTION == y ]]; then
    ...
    if [[ $OPTION == y ]]; then
      ...
      if [[ -f /home/${username}/.zshrc ]]; then
        ...
        if [[ $OPTION == y ]]; then
          sudo -u ${username} mv /home/${username}/.zshrc /home/${username}/.zshrc.bkp
          sudo -u ${username} cp /usr/share/oh-my-zsh/zshrc /home/${username}/.zshrc
        fi
      else
        sudo -u ${username} cp /usr/share/oh-my-zsh/zshrc /home/${username}/.zshrc
        sudo -u ${username} $EDITOR /home/${username}/.zshrc
      fi
    fi
    pause_function
  fi
...
install_desktop_environment(){
  ...
  case "$OPTION" in
    ...
    5)
      ...
      package_install "plasma kde-applications-meta kde-meta-kdenetwork kde-meta-kdeutils kde-l10n-$LOCALE_KDE sddm"
      # config xinitrc
...
install_accessories_apps(){
  ...
  do
    ...
    echo "11) $(menu_item "unified-remote-server" "Unified Remote")"
    echo ""
    echo " b) BACK"
    echo ""
    ...
    for OPT in ${OPTIONS[@]}; do
      case "$OPT" in
        ...
        9)
          ...
          package_install "libreoffice-fresh libreoffice-$LOCALE_LO"
          aur_package_install "hunspell-$LOCALE_HS"
          aur_package_install "aspell-$LOCALE_AS"
          ;;
        10)
      ...
      case "$OPT" in
        ...
        3)
          ...
          sudo -u ${username} mkdir -p /home/${username}/.config/aacs/ &&
            ...
            sudo -u ${username} wget http://vlc-bluray.whoknowsmy.name/files/KEYDB.cfg
          ;;
        "b")
          break
          ;;
    ...
    for OPT in ${OPTIONS[@]}; do
      case "$OPT" in
        ...
        2)
          ...
          sudo -u ${username} $EDITOR /home/${username}/.config/psd/psd.config
          sudo -u ${username} systemctl --user enable psd.service
          ;;
        "b")
          break
          ;;
