...
install_desktop_environment(){
  ...
  case "$OPTION" in
    ...
    5)
      ...
      package_install "plasma kf5 ark dolphin dolphin-plugins kio-extras kdeconnect quota-tools gwenview kipi-plugins kate kcalc konsole telepathy-kde kde-l10n-$LOCALE_KDE sddm"
      # config xinitrc
...
install_accessories_apps(){
  ...
  do
    ...
    echo " 7) $(menu_item "pyrenamer") $AUR"
    echo " 8) $(menu_item "enpass-bin") $AUR"
    echo " 9) $(menu_item "shutter hotshots" "$([[ ${KDE} -eq 1 ]] && echo "Hotshots" || echo "Shutter";)")"
...
install_fonts(){
  ...
  do
    ...
    echo " 5) $(menu_item "ttf-mac-fonts") $AUR"
