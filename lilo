...
install_development_apps(){
  ...
  do
    ...
    echo " 9) $(menu_item "mysql-workbench" "MySQL Workbench")"
    echo "10) $(menu_item "jdk7-openjdk" "OpenJDK")"
    echo "11) $(menu_item "jdk" "Oracle JDK") $AUR"
    echo "12) $(menu_item "nodejs")"
    echo "13) $(menu_item "visual-studio-code" "Microsoft Visual Studio Code") $AUR"
    echo ""
    echo " b) BACK"
    echo ""
