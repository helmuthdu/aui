...
install_cups(){
  ...
  if [[ $OPTION == y ]]; then
    ...
    package_install "gutenprint foomatic-db foomatic-db-engine foomatic-db-nonfree foomatic-filters foomatic-db-ppds foomatic-db-nonfree-ppds hplip splix cups-pdf"
...
install_desktop_environment(){
  install_icon_theme() { #{{{
    ...
    do
      ...
      echo " 1) $(menu_item "numix-icon-theme-git")"
      echo ""
      echo " b) BACK"
      echo ""
      ICONS_THEMES+=" b"
  ...
  case "$OPTION" in
    ...
    5)
      ...
      package_install "plasma kf5 ark dolphin dolphin-plugins gwenview kate kcalc konsole telepathy-kde kde-l10n-$LOCALE_KDE sddm"
      # config xinitrc
