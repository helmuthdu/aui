...
install_development_apps(){
  ...
  do
    ...
    echo " 6) $(menu_item "sublime-text-dev" "Sublime Text Dev") $AUR"
    ...
    echo " 9) $(menu_item "intellij-idea-ultimate-edition" "IntelliJ IDEA Ultimate Edition (Commercial)")"
    echo "10) $(menu_item "monodevelop")"
    echo "11) $(menu_item "qtcreator")"
    echo "12) $(menu_item "mysql-workbench" "MySQL Workbench") $AUR"
    echo "13) $(menu_item "jdk8-openjdk" "OpenJDK 8")"
    echo "14) $(menu_item "jdk9-openjdk" "OpenJDK 9")"
    echo "15) $(menu_item "jdk10-openjdk" "OpenJDK 10")"
    echo "16) $(menu_item "jdk" "Oracle JDK") $AUR"
    echo "17) $(menu_item "nodejs")"
    echo "18) $(menu_item "visual-studio-code-bin") $AUR"
    echo "19) $(menu_item "gitg" "Git GUI-s")"
    echo "20) $(menu_item "kdiff3" "Visual diff tools")"
    echo "21) $(menu_item "regexxer" "regexxer - Find and replace GUI tools")"
    echo ""
    echo " b) BACK"
    echo ""
    ...
    for OPT in ${OPTIONS[@]}; do
      case "$OPT" in
        ...
        8)
          ...
          ;;
        9)
          package_install "intellij-idea-ultimate-edition"
          ;;
        10)
