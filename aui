...
install_development_apps(){
  ...
  do
    ...
    echo " 3) $(menu_item "brackets") $AUR"
    echo " 4) $(menu_item "eclipse")"
    echo " 5) $(menu_item "emacs")"
    echo " 6) $(menu_item "gvim")"
    echo " 7) $(menu_item "geany")"
    echo " 8) $(menu_item "intellij-idea-community-edition" "IntelliJ IDEA")"
    echo " 9) $(menu_item "kdevelop")"
    echo "10) $(menu_item "lighttable") $AUR"
    echo "11) $(menu_item "monodevelop")"
    echo "12) $(menu_item "netbeans")"
    echo "13) $(menu_item "nodejs")"
    echo "14) $(menu_item "ruby" "Ruby on Rails")"
    echo "15) $(menu_item "jdk7-openjdk" "OpenJDK")"
    echo "16) $(menu_item "jdk" "Oracle JDK") $AUR"
    echo "17) $(menu_item "qtcreator")"
    echo "18) $(menu_item "sublime-text-dev" "Sublime Text") $AUR"
    echo "19) $(menu_item "gdb" "Debuggers")"
    echo "20) $(menu_item "mysql-workbench-gpl" "MySQL Workbench") $AUR"
    echo "21) $(menu_item "navicat-premium" "Navicat Premium") $AUR"
    echo "22) $(menu_item "meld")"
    echo ""
    echo " b) BACK"
    echo ""
...
install_office_apps(){
  ...
  do
    ...
    echo " 2) $(menu_item "goffice calligra-libs" "$([[ ${KDE} -eq 1 ]] && echo "Caligra" || echo "Abiword + Gnumeric";)")"
      ...
      case "$OPT" in
        ...
        4)
          ...
          do
            ...
            echo " 3) $(menu_item "konversation hexchat" "$([[ ${KDE} -eq 1 ]] && echo "Konversation" || echo "Hexchat";)")"
      ...
      case "$OPT" in
        ...
        2)
          ...
          do
            ...
            echo " 1) $(menu_item "arista-transcoder" "Arista") $AUR"
