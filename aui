...
install_xorg(){
  ...
  package_install "xorg-server xorg-xinit xorg-utils"
...
install_accessories_apps(){
  ...
  do
    ...
    echo " 7) $(menu_item "terra-bzr") $AUR"
    echo " 8) $(menu_item "kupfer") $AUR"
    echo " 9) $(menu_item "pyrenamer") $AUR"
...
install_development_apps(){
  ...
  do
    ...
    echo "16) $(menu_item "sql-power-architect" "SQL Power Architect") $AUR"
    echo "17) $(menu_item "meld")"
    echo "18) $(menu_item "rabbitvcs" "RabbitVCS") $AUR"
    echo ""
    echo " b) BACK"
    echo ""
    ...
    for OPT in ${OPTIONS[@]}; do
      case "$OPT" in
        ...
        14)
          ...
          aur_package_install "closure-compiler nodejs-jslint nodejs-jshint" #Javascript
          aur_package_install "nodejs-coffee-script" #coffeescript
        ...
        15)
          ...
          ;;
        16)
          aur_package_install "sql-power-architect"
          ;;
        17)
...
install_system_apps(){
  ...
  do
    ...
    echo " 5) $(menu_item "htop")"
    echo " 6) $(menu_item "virtualbox")"
    echo " 7) $(menu_item "webmin")"
    echo " 8) $(menu_item "wine")"
    echo ""
    echo " b) BACK"
    echo ""
    ...
    for OPT in ${OPTIONS[@]}; do
      case "$OPT" in
        1)
          ...
          sed -i '/START_FRESHCLAM/s/no/yes/' /etc/conf.d/clamav
          sed -i '/START_CLAMD/s/no/yes/' /etc/conf.d/clamav
      ...
      case "$OPT" in
        ...
        2)
          ...
          do
            ...
            echo " 6) $(menu_item "spideroak") $AUR"
...
install_web_server(){
  ...
  echo " 3) LNMP - NGINX, MariaDB & PHP + ADMINER"
  echo " 4) LNPP - NGINX, POSTGRESQL & PHP + ADMINER"
  echo ""
  echo " b) BACK"
  echo ""
...
install_fonts(){
  ...
  do
    ...
    echo " 5) $(menu_item "ttf-google-fonts-git") $AUR"
      ...
      case "$OPT" in
        1)
          ...
          do
            ...
            echo " 3) $(menu_item "contractor-bzr") (sharing)"
